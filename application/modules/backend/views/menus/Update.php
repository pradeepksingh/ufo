<div>
	...
	<form id="menuUpdate" name="menuUpdate" action="" method="post" enctype="multipart/form-data">
		...
		<div class="row">
			<div class="col-lg-12 margin-bottom-5">
				<div class="form-group">
					<div class="col-sm-5">
						<button type="submit" id="update_menu" class="btn btn-success" >Upload</button>
					</div>
				</div>
			</div>
		</div>

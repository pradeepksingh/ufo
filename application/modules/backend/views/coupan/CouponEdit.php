                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
							...
							<input type="hidden" name="coupon[id]" id="id" value="<?php echo $coupon['id'];?>"/>
                                <div class="row">
                                    <div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="coupon[title]" id="title" value="<?php echo $coupon['title'];?>"//>
                                            </div>
								     ...
								     <div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                             <input type="text" class="form-control" name="coupon[coupon_code]" id="coupon_code" value="<?php echo $coupon['coupon_code'];?>"/>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                      <div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                              <textarea class="form-control" name="coupon[description]" id="description" ><?php echo $coupon['description'];?></textarea>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                               	<select name="coupon[coupon_type]" id="coupon_type"  onchange="couponType(this.value);" class="form-control">
													<option value="0" <?php if($coupon['coupon_type'] == 0) { ?>selected<?php } ?>>Discount only</option>
													<option value="1" <?php if($coupon['coupon_type'] == 1) { ?>selected<?php } ?>>Cashback + Discount</option>
												</select>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                        ...
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                             <select name="coupon[is_new_user]" id="is_new_user" class="form-control">
													<option value="0" <?php if($coupon['is_new_user'] == 0) { ?>selected<?php } ?>>No</option>
													<option value="1" <?php if($coupon['is_new_user'] == 1) { ?>selected<?php } ?>>Yes</option>
												</select>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                        ...
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                               <select name="coupon[cat_id]" id="cat_id" class="form-control">
                                               		<option value="0" <?php if($coupon['cat_id'] == 0) { ?>selected<?php } ?>>All</option>
													<option value="1" <?php if($coupon['cat_id'] == 1) { ?>selected<?php } ?>>Device</option>
													<option value="2" <?php if($coupon['cat_id'] == 2) { ?>selected<?php } ?>>Kit</option>
													<option value="3" <?php if($coupon['cat_id'] == 3) { ?>selected<?php } ?>>Subscription</option>
												</select>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                             	<select name="coupon[discount_type]" id="discount_type" class="form-control">
													<option value="0" <?php if($coupon['discount_type'] == 0) { ?>selected<?php } ?>>Percentage</option>
													<option value="1" <?php if($coupon['discount_type'] == 1) { ?>selected<?php } ?>>Flat</option>
												</select>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
									...
									<div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                               	<input type="text" class="form-control" name="coupon[discount]" id="discount" value="<?php echo $coupon['discount'];?>"/>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
								     ...
								     <div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                               <input type="text" class="form-control" name="coupon[max_discount]" id="max_discount" value="<?php echo $coupon['max_discount'];?>" />
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                               <select name="coupon[cashback_type]" id="cashback_type" class="form-control">
													<option value="0" <?php if($coupon['cashback_type'] == 0) { ?>selected<?php } ?>>Percentage</option>
													<option value="1" <?php if($coupon['cashback_type'] == 1) { ?>selected<?php } ?>>Flat</option>
												</select>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                ...
                                <div class="row">
								     ...
								     <div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                               <input type="text" class="form-control" name="coupon[cashback]" id="cashback" value="<?php echo $coupon['cashback'];?>"/>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                    </div>
									 <div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                             <input type="text" class="form-control" name="coupon[max_cashback]" id="max_cashback" value="<?php echo $coupon['max_cashback'];?>"/>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
								     ...
								     <div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="coupon[min_order_value]" id="min_order_value" value="<?php echo $coupon['min_order_value'];?>"/>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                    </div>
									<div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                               <input type="text" class="form-control" name="coupon[count_per_user]" id="count_per_user" value="<?php echo $coupon['count_per_user'];?>"/>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
								     ...
								     <div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                               <input type="text" class="form-control date_picker" name="coupon[start_date]" id="start_date" value="<?php echo date('d-m-Y',strtotime($coupon['start_date']));?>" />
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                    </div>
									<div class="col-lg-6 margin-bottom-5">
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                              <input type="text" class="form-control date_picker" name="coupon[end_date]" id="end_date" value="<?php echo date('d-m-Y',strtotime($coupon['end_date']));?>"/>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group" id="error-mstart_time">
                                            ...
                                            <div class="col-sm-10">
                                              <select name="coupon[applicable_on]" id="applicable_on" class="form-control">
													<option value="0" <?php if($coupon['applicable_on'] == 0) { ?>selected<?php } ?>>Both</option>
													<option value="1" <?php if($coupon['applicable_on'] == 1) { ?>selected<?php } ?>>Website</option>
													<option value="2" <?php if($coupon['applicable_on'] == 2) { ?>selected<?php } ?>>APP</option>
												</select>
                                            </div>
                                            <div class="messageContainer col-sm-10" id="srest"><!--<div class='panel panel-default' style='' ><div class='panel-heading' style=''>Restaurant List</div><div class='panel-body' style='' style='padding:0px' ><div class='dataTable_wrapper' ><table class='table table-striped table-bordered table-hover' id='dataTables-example' ><thead class='bg-info'><tr><th>Restaurant</th><th>Area</th><th>Action</th></tr></thead><tbody id="ddd"></tbody></table></div></div></div>--></div>
                                        </div>

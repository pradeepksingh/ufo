                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        <label class="control-label">Password</label>
                                                       	<input type="password" id="password" name="password" value="" class="form-control" placeholder="Set password for Employee">
                                                     </div>
                                                     <div class="messageContainer"></div>
                                                </div>
                                            </div>
...
function addNewEmployee() {
	//alert('Hello');
	$.post(base_url+"admin/user/add", { first_name: $("#first_name").val(), last_name: $("#last_name").val(), email: $("#email").val(), mobile: $("#mobile").val(), status: $("#status").val(),  user_role: $("#user_role").val(),  password: $("#password").val()}, function(data){
		if(data.status == 1) {
			alert(data.msg);

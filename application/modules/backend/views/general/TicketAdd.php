								...
								<div class="row">
									<div class="col-lg-12 margin-bottom-5">
										<div class="form-group" id="error-subject">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" name="ticket[orderid]" id="orderid" />
											</div>
											<div class="messageContainer col-sm-4"></div>
										</div>
									</div>
								...
								<!--<div class="row">
									<div class="col-lg-12 margin-bottom-5">
										<div class="form-group" id="error-subject">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" name="ticket[quantity]" id="quantity" />
											</div>
											<div class="messageContainer col-sm-4"></div>
										</div>
									</div>
										...
										<div class="form-group" id="error-type">
											...
											<div class="col-sm-5">
												<select name="ticket[type]" id="type" class="form-control">
													...
													<option value="1">Wet Cleaning</option>
										...
										<div class="form-group" id="error-assigned_to">
											...
											<div class="col-sm-5">
												<select name="ticket[assigned_to]" id="assigned_to" class="form-control">
													...
													<option value="<?php echo $acp['id'];?>"><?php echo $acp['first_name'];?> <?php echo $acp['last_name'];?></option>
													<?php } ?>
												</select>
											</div>
											<div class="messageContainer col-sm-4"></div>
										...
										<div class="form-group" id="error-status">
											...
											<div class="col-sm-5">
												<select name="ticket[status]" id="status" class="form-control">
													...
													<option value="2">Wait For Response</option>

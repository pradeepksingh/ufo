		<div id="page-wrapper" >
			<div class="container-fluid">
				...
				<div class="row">
                                            ...
                                            <div class="row">
                                            	<div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" id="name" name="name" class="form-control" placeholder="Add status name"> 
                                                     </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info" id="status-list">
			                                ...
			                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
			                                    ...
			                                    $i++;
			                                        ...
			                                        <tr>
			                                            ...
			                                            <td><?php  if($status['is_active']==1){ echo "Enable"; } else {echo "Disable";}?></td>
			                                            <td><?php echo $status['first_name'].' '.$status['last_name'];?></td>
			                                             <td><a href="<?php echo base_url();?>admin/status/edit/<?php echo $status['id']; ?>"><i class="ti-pencil-alt"></i></a></td>
			                                        </tr>
			                                       <?php }?>
...
function addNewStatus() {
	$.post(base_url+"admin/status/add", { name: $("#name").val(),  status : $("#status").val() }, function(data){
		if(data.status == 1) {
			alert(data.msg);

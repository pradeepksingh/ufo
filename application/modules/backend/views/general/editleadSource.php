		<div id="page-wrapper" >
			<div class="container-fluid">
				<div class="row bg-title">General > Edit Lead Source</div>
				<div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading"> Edit Source</div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                <?php foreach($sources as $source) {?>
                                    <form action="" id="source-form"  method="post">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                            	<div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" id="name" name="name" value="<?php echo $source['name']; ?>" class="form-control" placeholder="eg: social media, newspaper etc. ">
                                                        <input type="hidden" id="source_id" name="source_id" value="<?php echo $source['id']; ?>" class="form-control" placeholder=" "> 
                                                     </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="status" name="status" required class="form-control"> 
                                                        	...
                                                        	<option value="1" <?php if($source['status']==1){ echo "selected"; } ?>>Enable</option>
                                                        	<option value="0" <?php if($source['status']==0){ echo "selected"; } ?>>Disable</option>
                                                        </select>
                                                     </div>
                                                </div>
                                            </div>
...
<script>
$('#source-form').bootstrapValidator({
...
function updateSource() {
	...
	$.post(base_url+"admin/source/update", { id: id, name: $("#name").val(),  status : $("#status").val() }, function(data){
		if(data.status == 1) {
			alert(data.msg);

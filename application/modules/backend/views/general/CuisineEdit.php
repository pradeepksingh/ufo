							...
							<div class="row">
								<div class="col-lg-12 margin-bottom-5">
									<div class="form-group" id="error-name">
										<label class="control-label col-sm-3">Cuisine Name <span class='text-danger'>*</span></label>
										<div class="col-sm-5">
...
function updateCuisine() {
	var options = {
	 		...
	 		url : base_url+'admin/general/updatecuisine',
	 		semantic : true,
	 		dataType : 'json'
	 	};
...
function showAddResponse(resp, statusText, xhr, $form){
	if(resp.status == '0') {
        ...
        $("#response").show();
        alert(resp.msg);
        window.location.href = base_url+"admin/general/cuisinelist";
  	}
}

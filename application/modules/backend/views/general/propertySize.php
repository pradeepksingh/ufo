		<div id="page-wrapper" >
			<div class="container-fluid">
				...
				<div class="row">
                                            ...
                                            <div class="row">
                                            	<div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" id="name" name="name" class="form-control" placeholder="eg: 1 BHK, 2 BHK etc."> 
                                                     </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info" id="property-list">
                                	...
                                	<div class="white-box">
			                            <div class="table-responsive">
			                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
			                                    ...
			                                    <?php 
			                                    $i = 0;
			                                    foreach($propertySize as $size) {
			                                    $i++;
			                                    	?>
			                                        <tr>
			                                        	<td><?php echo $i; ?></td>
			                                            <td><?php echo $size['name']?></td>
			                                            <td><?php  if($size['status']==1){ echo "Enable"; } else {echo "Disable";}?></td>
			                                            <td><?php echo $size['first_name'].' '.$size['last_name'];?></td>
			                                             <td><a href="<?php echo base_url();?>admin/property/size/edit/<?php echo $size['id']; ?>"><i class="ti-pencil-alt"></i></a></td>
			                                        </tr>
			                                       <?php }?>
...
function addNewStatus() {
	$.post(base_url+"admin/property/size/add", { name: $("#name").val(),  status : $("#status").val() }, function(data){
		if(data.status == 1) {
			alert(data.msg);

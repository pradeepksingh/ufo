...
<div id="page-wrapper">
	...
	<form id="editcity" name="editcity" action="" method="post">
							...
							<div class="row">
								<div class="col-lg-12 margin-bottom-5">
									<div class="form-group" id="error-name">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" id="name" name="name" value="<?php echo $cities[0]['name'];?>" />
										</div>
...
function addCity() {
	var options = {
	 		...
	 		url : base_url+'admin/general/updatecity',
	 		semantic : true,
	 		dataType : 'json'
	 	};
   	$('#editcity').ajaxSubmit(options);
}

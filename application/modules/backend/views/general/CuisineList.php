...
<div id="page-wrapper">
	<div class="row">
		...
		<div class="col-lg-12">
			<div class="btn-plus">
			<a href="<?php echo base_url();?>admin/general/newcuisine" class="btn btn-primary view-contacts bottom-margin">
				<i class="fa fa-plus"></i> Cuisine
			</a>
			</div>
                       	...
                       	<table class="table table-striped table-bordered table-hover" id="tblCuisine">
							...
							<?php foreach ($cuisines as $item):?>
								<tr>
									...
									<td>
										<a href="<?php echo base_url();?>admin/general/editcuisine/<?php echo $item['id']?>" class="btn btn-success icon-btn btn-xs"><i class="fa fa-pencil"></i></a>
...
function deleteCuisine(id) {
	if(confirm("Are you sure? you want to delete this cuisine ?")) {
		$.get(base_url+"admin/general/deletecuisine/"+id,{},function(data){
			alert(data.msg);

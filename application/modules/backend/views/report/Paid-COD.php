...
function search()
{
	...
	$.post(base_url+"admin/report/searchpaidvscod",{from_date: $("#from_date").val(), to_date: $("#to_date").val(), mode: $("#mode").val(), cityid: $("#cityid").val(), zone_id: $("#zone_id").val()},function(data){
	    ...
	    $(data).each(function(index){
		    ...
		    if(data[index].is_online_paid==0)
		    {
			    pmode = "COD";
		    }
		    else

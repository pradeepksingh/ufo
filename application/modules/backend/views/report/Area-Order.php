...
function search()
{
	...
	$.post(base_url+"admin/report/searchordervsarea",{from_date: $("#from_date").val(), to_date: $("#to_date").val(),cityid: $("#cityid").val(), zone_id: $("#zone_id").val(), areaid: $("#areaid").val()},function(data){
...
$("#zone_id").change(function(){
	$.get(base_url+"admin/general/zone/localities",{zone_id: $("#zone_id").val()},function(data){

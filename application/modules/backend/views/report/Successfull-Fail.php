	                	...
	                	<div class="form-group" id="error-cityid">
							...
							<div class="col-sm-4">
                            	<select name="status1" id="status1" class="form-control">
                            		...
                            		<option value="1"> Successfull Payment</option>
                            		<option value="0"> Failled Payment</option>
                            	</select>									
							</div>
                    	</div>
	             	</div>
              ...
              <table id="example1" class="display" cellspacing="0" width="100%">
		       ...
		       <?php if (isset($orders)) { ?>
		            	...
		            	<tr>
											...
											<td>
												<?php if($item['payment_status'] == 1) { echo "Successfull Payment"; } else { ?>Failled Payment<?php } ?>
											</td>
											<td>
...
function search() {
	...
	$.post(base_url+"admin/report/searchsuccessfullvsfail",{from_date: $("#from_date").val(), to_date: $("#to_date").val(), status: $("#status1").val(), cityid: $("#cityid").val(), zone_id: $("#zone_id").val()},function(data){
	    ...
	    $(data).each(function(index){
		    ...
		    if(data[index].payment_status==1)
		    {
		    	status = "Successful Payment";
		    }
		    else {
		    	status = "Failled Payment";
		    }

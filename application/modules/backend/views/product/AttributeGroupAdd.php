...
<div id="page-wrapper" >
	<div class="container-fluid">
		...
		<form id="addattrgroup" name="addattrgroup" action="" method="post" enctype="multipart/form-data">
...
<script>
$('#addattrgroup').bootstrapValidator({
...
function addAttributeGroup() {
	var options = {
	 		...
	 		url : base_url+'admin/attribute_group/add',
	 		semantic : true,
	 		dataType : 'json'
	 	};
   	$('#addattrgroup').ajaxSubmit(options);
}

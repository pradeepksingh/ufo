								...
								<div class="row">
									<div class="col-lg-6 margin-bottom-5">
										<div class="form-group" id="error-mobile">
											...
											<div class="col-sm-12">
												<input type="text" class="form-control" value="<?php if(!empty($customer['mobile'])) { echo $customer['mobile'];}  ?>" name="mobile" id="mobile" autocomplete="off"/>
											</div>
									...
									<div class="col-lg-6 margin-bottom-5">
										<div class="form-group" id="error-email">
											...
											<div class="col-sm-12">
												<input type="text" class="form-control" value="<?php if(!empty($customer['mobile'])) {  echo $customer['email']; }?>" name="email" id="email" autocomplete="off"/>
											</div>
											<div class="messageContainer col-sm-10"></div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-lg-6 margin-bottom-5">
										<div class="form-group" id="error-name">
											...
											<div class="col-sm-12">
												<input type="text" class="form-control" value="<?php if(!empty($customer['mobile'])) {  echo $customer['name']; }?>" name="name" id="name" autocomplete="off"/>
											</div>
											<div class="messageContainer col-sm-10"></div>
										</div>
									</div>
...
//         $.get(base_url+"crm/user/detail/"+item.value,{},function(result){
...
//     },
//     ajax: {
//         url: base_url+"crm/user/bymobile",
//         timeout: 500,
//         displayField: "mobile",
//         triggerLength: 3,
//         method: "get",

									...
									<tr>
										<td valign="top" >
											<a href="<?php echo base_url();?>">  
										 		<img src='<?php echo asset_url();?>images/logo.png' height='60px' width='205px' >
											</a> 
											<br />
										</td>
									</tr>
												...
												<tbody>
													<tr>
														<td style="padding-bottom:10px;">
															<h2 style="font-size:22px;font-weight:bold;color:#666666;font-family:'Calibri',sans-serif;font-weight:300;">  
																<span>Welcome</span> <?php echo $name;?> !
															</h2>
														</td>
													</tr>
													<tr>
														<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:'Calibri',sans-serif;font-weight:300;font-weight:2;">We understand that you have lot many other things to remember so here is your new username and password. </td>
													</tr>
													<tr>
													...
													<tr>													
														<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:Calibri,sans-serif;font-weight:300;font-weight:2;">Regards, <br> Phynart</td>
													</tr>
												</tbody>
											</table>
										</td>

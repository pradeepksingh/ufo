									...
									<tr>
										<td valign="top" >
											<a href="<?php echo base_url();?>">  
										 		<img src='<?php echo asset_url();?>images/logo.png' height='60px' width='85px' >
											</a> 
											<br />
										</td>
									</tr>
										...
										<td valign="top style=padding: 0px 13px 10px 14px;font-family:Calibri,Calibri,sans-serif;">
											<table width="100% cellspacing=0 cellpadding=0 style=background: #f7f7f9; padding: 15px;">
												<tbody>
													...
													<tr>
														<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:'Calibri',sans-serif;font-weight:300;font-weight:2;">Your OTP</td>
													</tr>
													<!--<tr>
													...
													<tr>
														<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:Calibri,sans-serif;font-weight:300;font-weight:2;">
															Username : <?php echo $data['email'];?> / <?php echo $data['mobile'];?>  <br />
															OTP : <?php echo $data['otp'];?>
														</td>
													</tr>
													<tr>													

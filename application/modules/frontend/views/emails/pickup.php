												...
												<tbody>
													<tr>
														<td style="padding-bottom:10px;">
															<h2 style="font-weight:bold;color:#666666;font-family:'Calibri',sans-serif;font-weight:300;">Hi There !</h2>
														</td>
													</tr>
													<tr>
														<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:'Calibri',sans-serif;font-weight:300;font-weight:2;">
															Our Moustache Man <?php echo $data['pickup_executive'];?> (<?php echo $data['pickup_executive_mobile'];?>) is out for your pick up / delivery.
														</td>
													</tr>
													<tr>
														<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:'Calibri',sans-serif;font-weight:300;font-weight:2;">
															Please get in touch with us.<br><br>
														</td>
													</tr>
													<tr>
														<td style="color:#666666;font-size:16px;padding-bottom:17px;font-family:Calibri,sans-serif;font-weight:300;font-weight:2;">

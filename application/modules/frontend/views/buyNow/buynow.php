   ...
   <div class="product-section">
      ...
      <div class="tab-content">
        ...
        <div id="home" class="tab-pane fade in active">
          ...
          <?php if(!empty($products['individuals']) && count($products['individuals']) > 0) { ?>
            <div class="row">
			<?php $i = 0; ?>
	        <?php foreach($products['individuals'] as $product) { ?>
	         <?php if ($i == 0) {  ?>           
               <div class="col-md-12 col-sm-12 product-show1">
                  <div class="col-md-6 col-sm-6">
                      <img src="<?php echo asset_url();?><?php echo $product['image'];?>" alt="product-images" class="img-responsive"/>
                  </div>
                  <div class="col-md-6 col-sm-6">
                  <?php //print_r($products);?>
                      <h3><?php echo $product['name'];?></h3>
                       <p><?php echo $product['short_description'];?></p>
                      <a href="<?php echo base_url();?>product/<?php echo $product['id']?>">Know More</a>
                  </div>
               </div>
               <?php } else { ?>
